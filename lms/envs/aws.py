...
SESSION_COOKIE_AGE = ENV_TOKENS.get('SESSION_COOKIE_AGE', SESSION_COOKIE_AGE)
...
DEFAULT_TEMPLATE_ENGINE['DIRS'].insert(0, COMPREHENSIVE_THEME_DIR / "lms/templates")
...
GOOGLE_ANALYTICS_DOMAIN = AUTH_TOKENS.get('GOOGLE_ANALYTICS_DOMAIN')
GOOGLE_ANALYTICS_LINKEDIN = AUTH_TOKENS.get('GOOGLE_ANALYTICS_LINKEDIN')

##### HEAP ANALYTICS ID #####
HEAP_ANALYTICS_ACCOUNT = AUTH_TOKENS.get('HEAP_ANALYTICS_ACCOUNT')
